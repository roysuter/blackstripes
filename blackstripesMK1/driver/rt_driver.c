...
//gcc -Wall -g -I/usr/include/xenomai -Ibcm2835-1.45/src bcm2835-1.45/src/bcm2835.c rt_driver.c -L/usr/lib/xenomai -lnative -lxenomai -o rt_driver
...
//export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/lib/xenomai
